...
import com.example.weswinng.fragments.calendario;
import com.example.weswinng.fragments.filtrosFragment;
import com.example.weswinng.fragments.novedadesFragment;
    ...
    public void clicklisteners(){
        reloj.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                novetatsFragment = new novedadesFragment();
        ...
        libreta.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FiltresFragment = new filtrosFragment();
                FragmentManager fm = getSupportFragmentManager();
                FragmentTransaction ft = fm.beginTransaction();
        ...
        calendario.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                calendariFragment = new calendario();
